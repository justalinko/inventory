                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                            ...
                            <div class="misc-box">   
                                <p class="text-center text-uppercase pad-v">
                                    <?php
                                    if(@$_GET['error']==1){ echo '<font color=red>Username atau password salah</font>';}else{ echo 'Login to continue.';} ?></p>
                                <?php echo form_open('auth/auth_signin',['role' => 'form']); ?>
                                    <div class="form-group">                                      
                                        <label class="text-muted" for="exampleuser1">UserName</label>
                                        <div class="group-icon">
                                        <input id="exampleuser1" type="text" placeholder="Username" class="form-control" required="" name="username">
                                   ...
                                   <!-- <p class=" text-center">Need to Signup?</p>
                                    <a href="<?=base_url();?>index.php/auth/register" class="btn btn-block btn-default">Register Now</a>-->
                            <?=form_close();?>
                            </div>
                            <div class="text-center misc-footer">
                                <span>&copy; Copyright 2019 GriyaRotan.com </span>
                            </div>
                        </div>
                    </div>
                </div>
